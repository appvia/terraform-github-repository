...
| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_advanced_collaborators"></a> [advanced\_collaborators](#input\_advanced\_collaborators) | Advanced collaborators with different permissions | `map(string)` | n/a | yes |
...
| <a name="input_collaborators"></a> [collaborators](#input\_collaborators) | Basic collaborators for the repository | <pre>object({<br/>    users = optional(map(object({<br/>      permission = optional(string, "triage")<br/>    })), {})<br/>    teams = optional(map(object({<br/>      permission = optional(string, "triage")<br/>    })), {})<br/>  })</pre> | `{}` | no |
